...
const QuizCard = () => {
  ...
  return (
    ...
    <>
    <div className="bg-[#2D1B24] p-8 md:p-10 rounded-2xl border border-[#840d5c]/20 relative overflow-hidden group shadow-2xl">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="space-y-4 pt-4">
          ...
          <button className="flex items-center justify-between w-full bg-[#840d5c] text-white px-6 py-4 text-[11px] font-bold uppercase tracking-[0.2em] hover:brightness-125 hover:shadow-[0_0_20px_rgba(132,13,92,0.4)] transition-all rounded-lg group"  onClick={() => setOpenFitQuiz(true)}>
