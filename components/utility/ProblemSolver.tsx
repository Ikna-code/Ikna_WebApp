...
const ProblemSolver = () => {
  return (
    ...
    <div className="w-full bg-[#320523] p-8 md:p-12 rounded-3xl space-y-10 shadow-2xl relative overflow-hidden">
      ...
      <div className="space-y-1 relative z-10 text-center md:text-left">
        ...
        <div className="w-12 h-1 bg-[#840d5c] mt-4 mx-auto md:mx-0 rounded-full"></div>
      </div>

      {/* ICON GRID */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
        {problems.map((item, index) => (
          <div key={index} className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-4 group p-2 md:p-8 bg-[#4d0836] rounded-2xl transition-all duration-500 hover:bg-[#840d5c]/20 border border-[#840d5c]/30 hover:border-[#c41a8e]">
      ...
      {/* FOOTER NOTE */}
      <div className="pt-6 border-t border-[#840d5c]/20 relative z-10">
