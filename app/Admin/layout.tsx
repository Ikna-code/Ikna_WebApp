...
export default async function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-dvh w-full bg-[#f8eef4] text-[#2f1126] antialiased overflow-x-hidden isolate">
      ...
      <main 
        className="admin-main-content min-w-0 min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-4 pb-14 pt-20 sm:px-6 sm:pb-10 sm:pt-24 lg:ml-64 lg:px-8 lg:pb-10 lg:pt-8"
        style={{
