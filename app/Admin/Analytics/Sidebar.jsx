...
export default function Sidebar({ adminUser }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-x-0 inset-y-0 left-0 z-50 flex w-screen max-w-screen flex-col justify-between bg-[#4b0333] p-5 text-[#f7edf4] shadow-2xl transition-transform duration-300 sm:max-w-80 sm:p-6 lg:sticky lg:top-0 lg:z-auto lg:h-screen lg:w-64 lg:max-w-none lg:self-start lg:translate-x-0 lg:shadow-none overflow-y-auto lg:overflow-hidden ${mobileOpen ? 'translate-x-0' : '-translate-x-full'} `}>
